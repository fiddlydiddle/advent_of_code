...
def main():
    ...
    print(len(particles)) # Part 2: Return number of particles left after removing collided particles in part 1
...
def part1(particles):
    ...
    for i in range(10000):
        ...
        unique_positions = {} # Part 2: Keep track of occupied positions for collision detection
        ...
        # Part 2: Remove particles that collided
...
def parse_coordinates(input):
    ...
    x_val, y_val, z_val = input[start + 1: end].split(',')
